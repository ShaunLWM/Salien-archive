...
{
	LoadAsset('intro_music', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/SS2018_Saliens_Intro2.{ogg,mp3}');
	LoadAsset('boot_bg', 'http://localhost/salien/steamcommunity/public/assets/saliengame/saliens_play_screen.png');
	LoadAsset('logo_bg', 'http://localhost/salien/public/images/saliengame/saliens_logo_bg.png');
	LoadAsset('logo', 'http://localhost/salien/public/images/saliengame/saliens_logo.png');	
	LoadAsset('saliens_rig_atlas', 'http://localhost/salien/public/images/saliengame/saliens_rig.atlas');
	LoadAsset('saliens_rig', 'http://localhost/salien/public/images/saliengame/saliens_rig.png');
	LoadAsset('saliens_rig_anim', 'http://localhost/salien/public/images/saliengame/saliens_rig.json');
	LoadAsset( 'ui_select', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/ui_item_select.{ogg,mp3}' );
	LoadAsset('sound_toggle', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sound_toggle.png');
	gLoader.load();
};
...
CPlanetSelectionState.prototype.Load = function()
{
	...
	gServer.GetPlanets( 0, function( results ) {
			...
			LoadAsset( 'planet_select_bg', 'http://localhost/salien/steamcommunity/public/assets/saliengame/planet_select_bg.jpg' );
			LoadAsset( 'galaxy_music', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/SS2018_Saliens_Planet.{ogg,mp3}' );
			LoadAsset( 'ship', 'http://localhost/salien/steamcommunity/public/assets/saliengame/ship.png');
			LoadAsset( 'ship_flag', 'http://localhost/salien/public/images/saliengame/ship_flag.png');			
			LoadAsset( 'grid_tile_boss', 'http://localhost/salien/public/images/saliengame/grid_tile_boss.png' );
			LoadAsset( 'grid_tile_complete', 'http://localhost/salien/public/images/saliengame/grid_tile_complete.png' );
			LoadAsset( 'ui_select_forward', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/ui_select_forward_confirm.{ogg,mp3}' );
			...
			instance.m_rgPlanets.forEach( function( planet ) {
				...
				LoadAsset( strPlanetName, 'http://localhost/salien/steamcommunity/public/assets//saliengame/planets/' + planet.state.image_filename );

				if ( planet.giveaway_apps !== undefined )
				{
					planet.giveaway_apps.forEach( function( appid ) {
						LoadAsset( 'app_' + appid, 'http://localhost/salien/steam/apps/' + appid + '/capsule_sm_120.jpg' );
					});
				}
			});
...
CBattleSelectionState.prototype.Load = function()
{
	...
	gServer.GetPlanet( this.m_unPlanetID, function (results ) {
			...
			LoadAsset( 'grid_tile_boss', 'http://localhost/salien/public/images/saliengame/grid_tile_boss.png' );
			LoadAsset( 'grid_tile_complete', 'http://localhost/salien/public/images/saliengame/grid_tile_complete.png' );
			LoadAsset( 'map_bg_' + instance.m_PlanetData.id, 'http://localhost/salien/steamcommunity/public/assets/saliengame/maps/' + instance.m_PlanetData.state.map_filename );
			LoadAsset( 'galaxy_music', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/SS2018_Saliens_Planet.{ogg,mp3}' );
			LoadAsset( 'ui_select_backwards', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/ui_select_backwards_deny.{ogg,mp3}' );
			LoadAsset( 'easy_difficulty', 'http://localhost/salien/steamcommunity/public/assets/saliengame/low.png' );
			LoadAsset( 'medium_difficulty', 'http://localhost/salien/steamcommunity/public/assets/saliengame/medium.png' );
			LoadAsset( 'hard_difficulty', 'http://localhost/salien/steamcommunity/public/assets/saliengame/high.png' );
			LoadAsset( 'boss_difficulty', 'http://localhost/salien/steamcommunity/public/assets/saliengame/boss.png' );
...
{
	var instance = this;
	LoadAsset( 'attack_config', 'http://localhost/salien/steamcommunity/public/assets//saliengame/attacks.json', '8' );
	LoadAsset( 'enemy_config', 'http://localhost/salien/steamcommunity/public/assets//saliengame/enemies.json', '11' );
	LoadAsset( 'level_config', 'http://localhost/salien/steamcommunity/public/assets//saliengame/levels.json', '10' );
	LoadAsset( 'enemy-spritesheet-0', 'http://localhost/salien/steamcommunity/public/assets/saliengame/enemy-spritesheet-0.json' );
	LoadAsset( 'enemy-spritesheet-1', 'http://localhost/salien/steamcommunity/public/assets/saliengame/enemy-spritesheet-1.json' );
	LoadAsset( 'enemy-spritesheet-2', 'http://localhost/salien/steamcommunity/public/assets/saliengame/enemy-spritesheet-2.json' );
	LoadAsset( 'explosion-sprite', 'http://localhost/salien/steamcommunity/public/assets/saliengame/explosion.json' );
	LoadAsset( 'laser-sprite', 'http://localhost/salien/steamcommunity/public/assets/saliengame/laser-sprite.json' );
	LoadAsset( 'enemy-death', 'http://localhost/salien/steamcommunity/public/assets/saliengame/enemy-death.json' );
	LoadAsset( 'slime-attack', 'http://localhost/salien/steamcommunity/public/assets/saliengame/slime-attack.json' );
	LoadAsset( 'beast-attack', 'http://localhost/salien/steamcommunity/public/assets/saliengame/beast-attack.json' );
	LoadAsset( 'psychic-attack', 'http://localhost/salien/steamcommunity/public/assets/saliengame/psychic-attack.json' );
	LoadAsset( 'battle_music', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/SS2018_Saliens_Battle5.{ogg,mp3}' );
	LoadAsset( 'boulder', 'http://localhost/salien/steamcommunity/public/assets/saliengame/boulder.png' );
	LoadAsset( 'blackhole', 'http://localhost/salien/steamcommunity/public/assets/saliengame/blackhole.png' );
	LoadAsset( 'bomb', 'http://localhost/salien/steamcommunity/public/assets/saliengame/space-bomb2.png' );
	LoadAsset( 'healing', 'http://localhost/salien/steamcommunity/public/assets/saliengame/healing.json' );
	LoadAsset( 'flash_freeze', 'http://localhost/salien/steamcommunity/public/assets/saliengame/iced_enemy.png' );
	LoadAsset( 'stinger_win', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/stinger_win.{ogg,mp3}' );
	LoadAsset( 'stinger_lose', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/stinger_lose.{ogg,mp3}' );
	LoadAsset( 'boulder_land', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/boulder_land.{ogg,mp3}' );
	LoadAsset( 'boulder_roll', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/boulder_roll.{ogg,mp3}' );
	LoadAsset( 'bomb_explode', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/bomb_explode.{ogg,mp3}' );
	LoadAsset( 'slime_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/attack_green.{ogg,mp3}' );
	LoadAsset( 'beast_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/attack_red.{ogg,mp3}' );
	LoadAsset( 'psychic_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/attack_purple.{ogg,mp3}' );
	LoadAsset( 'blackhole_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/blackhole.{ogg,mp3}' );
	LoadAsset( 'freeze_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/freeze_start.{ogg,mp3}' );
	LoadAsset( 'ship_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/ship_entry.{ogg,mp3}' );
	LoadAsset( 'beam_down', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/beam_down.{ogg,mp3}' );
	LoadAsset( 'ship_full', 'http://localhost/salien/steamcommunity/public/assets/saliengame/salien_ship_full2.png' );
	LoadAsset( 'keyboard1', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard1.png' );
	LoadAsset( 'keyboard2', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard2.png' );
	LoadAsset( 'keyboard3', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard3.png' );
	LoadAsset( 'keyboard4', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard4.png' );
	LoadAsset( 'keyboard5', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard5.png' );
	LoadAsset( 'keyboard6', 'http://localhost/salien/steamcommunity/public/assets/saliengame/keyboard6.png' );
	LoadAsset( 'slime_ability', 'http://localhost/salien/steamcommunity/public/assets/saliengame/slime_ability.png' );
	LoadAsset( 'beast_ability', 'http://localhost/salien/steamcommunity/public/assets/saliengame/beast_ability.png' );
	LoadAsset( 'psychic_ability', 'http://localhost/salien/steamcommunity/public/assets/saliengame/psychic_ability.png' );
	LoadAsset( 'impact_sound', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/box_metal_impact.{ogg,mp3}' );
	LoadAsset( 'laser_shoot', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/weapon_laser_shoot.{ogg,mp3}' );
	LoadAsset( 'laser_impact', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/weapon_laser_impact.{ogg,mp3}' );
	LoadAsset( 'lvlonedeath', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/lvlonedeath.{ogg,mp3}' );
	LoadAsset( 'lvltwodeath', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/lvltwodeath.{ogg,mp3}' );
	LoadAsset( 'lvlthreedeath', 'http://localhost/salien/steamcommunity/public/assets/saliengame/sfx/lvlthreedeath.{ogg,mp3}' );
	LoadAsset( 'cables', 'http://localhost/salien/steamcommunity/public/assets/saliengame/cables.png' );
	LoadAsset( 'satellite', 'http://localhost/salien/steamcommunity/public/assets/saliengame/satellite.png' );
	LoadAsset( 'station', 'http://localhost/salien/steamcommunity/public/assets/saliengame/station.png' );
	LoadAsset( 'turret', 'http://localhost/salien/steamcommunity/public/assets/saliengame/turret.png' );
	LoadAsset( 'turret_obscuring', 'http://localhost/salien/steamcommunity/public/assets/saliengame/turret_obscuring.png' );
	LoadAsset( 'barrel', 'http://localhost/salien/steamcommunity/public/assets/saliengame/barrel_small.png' );
	LoadAsset( 'battle_background_' + this.m_PlanetData.id, 'http://localhost/salien/steamcommunity/public/assets/saliengame/backgrounds/' + this.m_PlanetData.state.land_filename );
	LoadAsset( 'beam', 'http://localhost/salien/steamcommunity/public/assets/saliengame/beam.json' );
	LoadAsset( 'lock', 'http://localhost/salien/steamcommunity/public/assets/saliengame/lock.png' );
...
CBattleState.prototype.OnLoadComplete = function(loader, resources)
{
	...
	//Css style for icons
	var defaultIcon = "url('http://localhost/salien/steamcommunity/public/assets/saliengame/reticle_blue.png') 16 16, auto";
	var hoverIcon = "url('http://localhost/salien/steamcommunity/public/assets/saliengame/reticle.png') 16 16, auto";
